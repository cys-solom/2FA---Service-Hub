    ...
    <footer className="text-center py-6 mt-4 space-y-4">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#1877F2]/10 border border-[#1877F2]/20 text-[#1877F2] hover:bg-[#1877F2]/20 hover:border-[#1877F2]/30 transition-all duration-200 text-xs font-medium"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#25D366]/10 border border-[#25D366]/20 text-[#25D366] hover:bg-[#25D366]/20 hover:border-[#25D366]/30 transition-all duration-200 text-xs font-medium"
